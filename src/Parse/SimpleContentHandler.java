...
/**
 * Parsing the xml file to generate the map of the world and the creatures / objects on it.
 */
public class SimpleContentHandler implements ContentHandler{
	private Locator locator;
	private static Environment env=new Environment(0, 0, BackgroundType.Earth);
